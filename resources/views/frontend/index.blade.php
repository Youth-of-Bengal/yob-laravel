      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">A Journey to the Better World</h1>
            <p class="mb-5" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">"আমরা মানুষ বাঁচানোর নেশা করি..."</p>
          ...
          <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
            <div class="block-18 color-3 align-items-stretch">
              <div class="text">
              	...
              	<p>We have a deep passion for the work that we do to improve the efficiency and effectiveness of the nonprofit sector, as well as how donors think about the way they give to it.</p>
              	<p><a href="{{ url('/member') }}" class="btn btn-white px-3 py-2 mt-2">Be A Member</a></p>
              </div>
            </div>
          </div>
    		</div>
      ...
      <div class="container">
        ...
        <div class="row d-flex">
          ...
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <a href="blog-single.html" class="block-20" style="background-image: url({{ URL::to('/')}}{{ Illuminate\Support\Facades\Storage::url($news->image) }}" class="thumbnailImage" width="50px" height="50px" alt="{{ $news->title }});">
              </a>
              <div class="text p-4 d-block">
              	<div class="meta mb-3">
                  <div><a href="#">{{ $news->title }}</a></div>
                </div>
                <h3 class="heading mt-3"><a href="#">{{ $news->publish_date }}</a></h3>
